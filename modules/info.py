...
def doc(phenny, input): 
   ...
   if phenny.doc.has_key(name): 
      doc_string = (' ').join(phenny.doc[name][0].split())
      phenny.reply(doc_string)
...
def help(phenny, input): 
   response = (
      'Hi, I\'m a bot. Say ".commands" to me for a list of my ' + 
      'commands, or see http://inamidst.com/phenny/ for more ' + 
